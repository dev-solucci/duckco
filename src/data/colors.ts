...
export const palette: BrandColor[] = [
  {
    ...
    hex: "#0B0B0B",
    role: "core",
    usage: "Streetwear base — tees, backgrounds, tags, high contrast.",
  },
  {
    id: "duck-cream",
    name: "Duck Cream",
    hex: "#F3E7CF",
    role: "core",
    usage: "Vintage backgrounds, labels, silk, retro language.",
  },
  {
    id: "lucky-yellow",
    name: "Lucky Yellow",
    hex: "#F5B700",
    role: "core",
    usage: "Primary mascot yellow — luck, energy, Luke.",
  },
  {
    id: "money-green",
    name: "Money Green",
    hex: "#1F4D2B",
    role: "core",
    usage: "Luck, money, victory, premium feel.",
  },
  {
    id: "street-brown",
    name: "Street Brown",
